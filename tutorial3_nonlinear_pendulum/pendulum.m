function [t, theta, omega] = pendulum(tmax, level, theta0, omega0, tracefreq)
%  pendulum Solves the nonlinear pendulum equation using an O(deltat^2) FDA [PHYS210-pendulum]
%  
%  Input arguments
%
